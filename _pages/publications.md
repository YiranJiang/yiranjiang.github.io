...
- Modern Synthetic Data Generation for Transportation: Methods, Domain Constraints, and Evaluation\
...
- Estimation of Over-parameterized Models from an Auto-Modeling Perspective\
  **Yiran Jiang** and Chuanhai Liu <i class="fas fa-envelope"></i>\
  _Journal of the American Statistical Association_ (2025). \
...
- Scalable Community Detection in Massive Networks Using Aggregated Relational Data\
  Timothy Jones, Owen G. Ward, **Yiran Jiang**, John Paisley and Tian Zheng <i class="fas fa-envelope"></i>\
  _Statistica Sinica_ (2025).   
...
- Real-time onboard SVM-based human locomotion recognition for a bionic knee exoskeleton on different terrains\
  Zhihao Zhou, Xiuhua Liu, **Yiran Jiang**, Jingeng Mai, Qining Wang <i class="fas fa-envelope"></i>\
