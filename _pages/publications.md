...
- Estimation of Over-parameterized Models from an Auto-Modeling Perspective\
  **Yiran Jiang** and Chuanhai Liu\
  _Journal of the American Statistical Association_ (2025), in press. \
  [[paper](https://arxiv.org/abs/2206.01824)] [[code](https://github.com/YiranJiang/Estimation-of-Over-parameterized-Models-from-an-Auto-Modeling-Perspective)]
...
- Empowering Genome-wide Association Studies via a Visualizable Test Based on Regional Association Score\
  **Yiran Jiang** and Heping Zhang\
  _Proceedings of the National Academy of Sciences_ (2025), in press.
